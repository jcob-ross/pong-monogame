namespace PongMonoGame
{
  ...
  /// <summary>
  ///   Letterboxing screen adapter
  /// </summary>
  public class LetterBoxScreenAdapter : ScalingScreenAdapter
  {
    private readonly GraphicsDeviceManager _graphicsDeviceManager;
    private readonly GameWindow _window;

    /// <summary>
    /// Initializes a new instance of the <see cref="LetterBoxScreenAdapter"/>. 
    ...
    /// </summary>
    public LetterBoxScreenAdapter(GameWindow window, GraphicsDevice graphicsDevice, int virtualWidth, int virtualHeight)
    ...
    /// </summary>
    public LetterBoxScreenAdapter(GameWindow window, GraphicsDeviceManager graphicsDeviceManager, int virtualWidth, int virtualHeight)
      : this(window, graphicsDeviceManager.GraphicsDevice, virtualWidth, virtualHeight)
    {
      if (null == graphicsDeviceManager)
