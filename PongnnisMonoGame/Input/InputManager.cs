namespace PongMonoGame
{
  ...
  public class InputManager : GameComponent
  {
    ...
    public int DistanceScrolled => _currentMouseState.ScrollWheelValue - _priorMouseState.ScrollWheelValue;
    public bool MouseIsScrollingUp => _currentMouseState.ScrollWheelValue > _priorMouseState.ScrollWheelValue;
    public bool MouseIsScrollingDown => _currentMouseState.ScrollWheelValue < _priorMouseState.ScrollWheelValue;
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      _mousePosition = _currentMouseState.Position.ToVector2();
      foreach (var mouseButton in Enum.GetValues(typeof(MouseButtons)))
      {
